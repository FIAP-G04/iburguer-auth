...
WORKDIR /src
COPY ["IBurguer.Onboarding.SignUp.csproj", "IBurguer.Onboarding.SignUp/"]
RUN dotnet restore "IBurguer.Onboarding.SignUp/IBurguer.Onboarding.SignUp.csproj"

WORKDIR "/src/IBurguer.Onboarding.SignUp"
COPY . .
RUN dotnet build "IBurguer.Onboarding.SignUp.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "IBurguer.Onboarding.SignUp.csproj" \
